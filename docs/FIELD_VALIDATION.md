...
Field summaries are generated by `src/field-summary-cli.ts` and include rule/node evidence quality, incomplete/unmapped rule metadata, coverage-engine provenance, and journey versions/outcomes.
